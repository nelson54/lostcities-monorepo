...
job "nginx-ingress-internal" {
  ...
  group "nginx-ingress-internal" {
    ...
    service {
      name = "nginx-ingress-secure-internal"
      port = "https"
    }
...
server {
    server_name promethues.lostcities.dev uptime.lostcities.dev fabio.lostcities.app dashboard.lostcities.app grafana.lostcities.app prometheus-agent.lostcities.app prometheus.lostcities.app rabbitmq.lostcities.app;
